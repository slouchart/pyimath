...
class TestAdditiveGroup(TestCase):
    ...
    def testGR3(self):
        """Checking low level primitive for addition in F3
        """
    ...
    def testGR5(self):
        """Checking low level primitive for addition in F5
        """
    ...
    def testGR7(self):
        """Checking low level primitive for addition in F7
        """
...
class TestMultiplicativeGroup(TestCase):
    ...
    def testMULGR2(self):
        ...
        """
        self.assertTrue(PrimeField._pf_mul(1, 1, self.mulgr2) == 1)
        self.assertTrue(PrimeField._pf_mul(1, 0, self.mulgr2) == 0)

    def testMULGR3(self):
        """Checking low level primitive for multiplication in F3
        """
        self.assertTrue(PrimeField._pf_mul(-1, -1, self.mulgr3) == 1)

    def testMULGR5(self):
        """Checking low level primitive for multiplication in F5
        """
    ...
    def testMULGR7(self):
        """Checking low level primitive for multiplication in F7
        """
...
class TestFieldOps(TestCase):
    ...
    def TestAllOperators(self):
        """Checking all operators in F5 (sanity check of the __<op>__ interface)"""
        f5 = self.f5
        u = f5(2)
        v = f5(-1)
